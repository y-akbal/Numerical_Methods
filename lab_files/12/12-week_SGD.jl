...
function fit!(lr::linear_regression, X::AbstractMatrix, y::AbstractVector; epochs ::Int64 = 10, batch_size::Int64 = 32)
...
fit!(lr, randn(1000,200), randn(10000); batch_size = 128, epochs = 10000)